...
module OnlineOps.Object.ConnectAccount exposing (..)
...
id : SelectionSet OnlineOps.ScalarCodecs.Id OnlineOps.Object.ConnectAccount
id =
    Object.selectionForField "ScalarCodecs.Id" "id" [] (OnlineOps.ScalarCodecs.codecs |> OnlineOps.Scalar.unwrapCodecs |> .codecId |> .decoder)


options : SelectionSet decodesTo OnlineOps.Object.SetupOption -> SelectionSet (Maybe (List (Maybe decodesTo))) OnlineOps.Object.ConnectAccount
options object_ =
